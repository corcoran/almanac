-- Widen the accomplishments.code CHECK to admit the sleep-recovery win
-- ('sleep_recovery'). Builds on migrations 012 ('strength_pr'),
-- 013 ('phase_complete'/'phase_halfway') and 014 (lifetime/volume totals) —
